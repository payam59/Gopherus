def PostgreSQL():
    ...
    start = "000000" + str((4+len(user)+8+len(db)+13).to_bytes(1, byteorder="big").hex()) + "000300"
    data = "00" + "user".encode("hex").decode() + "00" + encode_user + "00" + "database".encode("hex").decode() + "00" + encode_db
